    ...
    <LayoutPlain
      ...
      <div
        ...
        <p>
          ...
          Pembelian layanan kursus harus dilakukan dengan menggunakan akun calon student agar user dapat tercatat sebagai student untuk kursus tersebut.</p>
          <p>Mekanisme Pengembalian Dana (Refund)</p>
          <p>Force Majeure: Pelanggan berhak mendapatkan pengembalian dana yang telah dibayarkan jika dalam proses transaksi maupun pembelajaran berjalan terdapat force majeure. Yang dimaksud dengan force majeure dalam hal ini adalah keadaan atau peristiwa yang terjadi di luar dugaan, kemampuan, dan kekuasaan para pihak yang mengakibatkan terhambatnya aktivitas transaksi maupun belajar mengajar, seperti:</p>
          ...
          <p>Pelanggan yang mengalami kondisi force majeure akan menerima pengembalian dana setelah dokumen-dokumen bukti yang diperlukan dipenuhi oleh Pelanggan dan disetujui oleh pihak yang berwenang di Xerpihan dan/atau mitra Xerpihan.
          Pelanggan tidak diizinkan mengajukan pengembalian dana sesudah layanan dimulai/diproses.</p>
          <p>Pengembalian dana diproses dengan ketentuan sebagai berikut:</p>
