...
export const caseStudy2 = [
  { title: 'Implementation of fuzzy lasogic', subtitle: 'Institut Teknologi Surabaya', link: '/' },
  { title: 'Implementation of fuzzy loasssgic', subtitle: 'Institut Teknologi Surabaya', link: '/' },
];
